    ...
    return (
        <>
            ...
            <main className="relative">
               ...
               {/* معرفی نرم‌افزار صنعتی و بازرگانی رهان */}
<section className="max-w-6xl mx-auto px-6 py-16 space-y-12">

{/* تیتر اصلی */}
<h2 className="text-3xl font-bold">نرم‌افزار صنعتی و بازرگانی <strong>رهان</strong></h2>

<div className="space-y-8">
  {/* توضیح کلی */}
  <p className="text-muted-foreground leading-7 max-w-3xl">
    نرم‌افزار صنعتی و بازرگانی <strong>رهان</strong> یک راهکار سبک، سریع و کاربردی است که برای کسب‌وکارهای صنعتی، تولیدی و بازرگانی طراحی شده است. این سیستم فرآیندهای عملیاتی، خرید، فروش و انبارداری را به شکل ساده و یکپارچه مدیریت می‌کند و با تمرکز بر افزایش بهره‌وری و کاهش خطاهای انسانی، به رشد کسب‌وکار شما کمک می‌کند.
  </p>

  {/* بخش خرید */}
  <h3 className="text-2xl font-semibold">ماژول خرید</h3>
  <p className="text-muted-foreground leading-7 max-w-3xl">
    امکان تعریف چندین سطح تأیید سفارش و مدیریت تأمین‌کنندگان، فرآیند سفارش‌دهی را دقیق و قابل پیگیری می‌کند. این ویژگی باعث کاهش خطاهای انسانی و بهینه‌سازی جریان خرید می‌شود.
  </p>

  {/* بخش فروش */}
  <h3 className="text-2xl font-semibold">ماژول فروش</h3>
  <p className="text-muted-foreground leading-7 max-w-3xl">
    ثبت سفارشات، مدیریت قیمت‌ها و تخفیف‌ها و پیگیری قراردادها به تیم فروش کمک می‌کند تا عملکرد شفاف و بهینه داشته باشد. فرآیندهای فروش دقیق‌تر و تصمیم‌گیری‌ها سریع‌تر انجام می‌شوند.
  </p>

  {/* بخش انبار */}
  <h3 className="text-2xl font-semibold">ماژول انبار</h3>
  <p className="text-muted-foreground leading-7 max-w-3xl">
    کنترل موجودی، ورود و خروج کالا و اتصال مستقیم به سیستم خرید و فروش، هماهنگی بین واحدها را بهبود می‌دهد و فرآیندهای انبارداری را به شکل دقیق مدیریت می‌کند.
  </p>

  {/* گزارش‌ها و تحلیل */}
  <h3 className="text-2xl font-semibold">گزارش‌ها و تحلیل‌ها</h3>
  <p className="text-muted-foreground leading-7 max-w-3xl">
    مدیران و کارکنان می‌توانند گزارش‌های تحلیلی و عملیاتی سریع دریافت کنند، فرآیندهای روزمره و تکراری کاهش یابد و هماهنگی بین واحدهای مختلف سازمان به شکل قابل توجهی بهبود پیدا کند.
  </p>

  {/* مزایای سازمانی */}
  <h3 className="text-2xl font-semibold">مزایای سازمانی</h3>
  <p className="text-muted-foreground leading-7 max-w-3xl">
    این نرم‌افزار گزینه‌ای ایده‌آل برای شرکت‌های صنعتی و بازرگانی کوچک تا متوسط است که می‌خواهند بدون پیچیدگی‌های نرم‌افزارهای سازمانی بزرگ، فرآیندهای خود را شفاف، سریع و کنترل‌شده مدیریت کنند و مسیر رشد و توسعه کسب‌وکارشان را هموارتر کنند.
  </p>
</div>
</section>
